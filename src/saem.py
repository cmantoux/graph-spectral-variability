...
from src import spa, vmf, mcmc, model, model_bin, model_cluster, model_bin_cluster


np.random.seed(0)


def mcmc_saem(As, Xs_mh, ls_mh, theta, n_iter=100, mala=False, prop_X=0.01, prop_l=0.5, n_mcmc=20, history=True, setting="gaussian"):
    ...
    for n in trange(n_iter):
        ...
        if mala:
            ...
            Xs_mh, ls_mh, lk, rate_X, rate_l = mcmc.mh(As, theta, n_iter=n_mcmc,
                                      init=(Xs_mh, ls_mh),
