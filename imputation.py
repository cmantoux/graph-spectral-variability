"""
This script reproduces the experiment of section 5.1.2 on missing link imputation.
...
result = saem.mcmc_saem(As, Xs_mh, ls_mh, theta, n_mcmc=20, n_iter=2000)
...
for i in trange(n_samples):
    ...
    n_iter = 10000
    A_mcmc, X_mcmc, l_mcmc, lks_mcmc = mcmc.mh_mask(A, mask, theta, n_iter=n_iter)
